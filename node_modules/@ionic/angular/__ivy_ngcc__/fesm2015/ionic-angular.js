...
import { HostListener, ElementRef, Directive, Inject, NgZone, ɵɵdefineInjectable, ɵɵinject, Injectable, Optional, ChangeDetectorRef, Component, ChangeDetectionStrategy, InjectionToken, ApplicationRef, Injector, EventEmitter, ViewContainerRef, ComponentFactoryResolver, Attribute, SkipSelf, Output, ViewChild, ContentChild, TemplateRef, IterableDiffers, APP_INITIALIZER, NgModule } from '@angular/core';
...
const _c2 = [[["", "slot", "top"]], "*"];
const _c3 = ["[slot=top]", "*"];
export { iosTransitionAnimation, mdTransitionAnimation } from '@ionic/core';
...
Config.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: Config, factory: Config.ɵfac, providedIn: 'root' });
...
AngularDelegate.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: AngularDelegate, factory: AngularDelegate.ɵfac });
...
ActionSheetController.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ActionSheetController, factory: ActionSheetController.ɵfac, providedIn: 'root' });
...
AlertController.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: AlertController, factory: AlertController.ɵfac, providedIn: 'root' });
...
LoadingController.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: LoadingController, factory: LoadingController.ɵfac, providedIn: 'root' });
...
MenuController.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: MenuController, factory: MenuController.ɵfac, providedIn: 'root' });
...
PickerController.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: PickerController, factory: PickerController.ɵfac, providedIn: 'root' });
...
ToastController.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ToastController, factory: ToastController.ɵfac, providedIn: 'root' });
...
DomController.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: DomController, factory: DomController.ɵfac, providedIn: 'root' });
...
GestureController.ɵfac = function GestureController_Factory(t) { return new (t || GestureController)(); };
GestureController.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: GestureController, factory: GestureController.ɵfac, providedIn: 'root' });
GestureController.ngInjectableDef = ɵɵdefineInjectable({ factory: function GestureController_Factory() { return new GestureController(); }, token: GestureController, providedIn: "root" });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(IonicModule, { declarations: function () { return [IonApp,
        ...
        VirtualHeader,
        VirtualItem,
        IonVirtualScroll]; }, imports: function () { return [CommonModule]; }, exports: function () { return [IonApp,
        IonAvatar,
        IonBackButton,
        IonBackdrop,
        IonBadge,
